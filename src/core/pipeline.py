...
# ====================== 火山方舟豆包分析器（替换原 Gemini） ======================
class VolcanoArkAnalyzer:
    """火山方舟 Doubao 分析器，兼容原 AnalysisResult 输出结构"""
    ...
    def _parse_llm_output(self, text: str, ctx: dict):
...
class StockAnalysisPipeline:
    ...
    def __init__(
        ...
        self.analyzer = VolcanoArkAnalyzer(config=self.config, skills=self.analysis_skills)
